...
% \item $\t$ and $\e$ that represent terms and expressions, based on \figref{fig:syntax-of-types-terms-expressions}.
...
% \item Modules \texttt{DeclarativeTyping}$\T$, \texttt{DeclarativeTyping}$\A$, and \texttt{DeclarativeTyping}$\T\A$, that implement the Figures \ref{fig:typing-rules-for-nonlinear-types}, \ref{fig:typing-rules-for-linear-types}, and \ref{fig:typing-rules-for-linear-and-nonlinear-types}, respectively.
