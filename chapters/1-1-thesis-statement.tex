...
\begin{itemize}
    ...
    \item \chapref{chap:typescript-implementation} presents an implementation of LTTT in TypeScript, to demonstrate LTTT in practice, and to set an infrastructure for further discussion.
\end{itemize}