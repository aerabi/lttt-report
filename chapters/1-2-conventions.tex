...
\chapref{chap:coq-implementation} discusses a Coq implementation of the theory, so familiarity with syntax of Coq is helpful. Similarly, familiarity with syntax of TypeScript is helpful for \chapref{chap:typescript-implementation}.