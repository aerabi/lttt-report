...
\begin{document}
    ...
    \input{chapters/3-the-logic}
    \input{chapters/4-approach}
    \input{chapters/5-typescript-implementation}
    ...
    % 1.1. dependent schemas and basic proofs
    % 2. the generic store
    % 3. the typing rules
    % 4. the operational semantics
    % 5. the lemmas the we are trying to prove
    % 6. add quickchick results
